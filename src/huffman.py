...
ENCODE_OUTPUT = "C:/Users/pma98/Desktop/SM/out/encoded.png"
...
if __name__ == '__main__':
    #Read image
    img = cv.imread(ENCODE_INPUT, cv.IMREAD_UNCHANGED)
    ...
    cv.imwrite("C:/Users/pma98/Desktop/SM/out/decoded.png", np.array(list(encoding.keys()), dtype=np.uint8), [cv.IMWRITE_PNG_COMPRESSION, 0])